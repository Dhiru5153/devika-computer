...
const ContactUs = () => {
   ...
   <>
      ...
      <main
         style={{
            filter: pageLoading ? "blur(4px)" : "none",
            transition: "filter 0.3s ease",
            pointerEvents: pageLoading ? "none" : "auto"
         }}
      >
         <Hero preHeading='Reliable. Affordable. Professional.'
         heading='Contact Us'
         text='Expert Computer, Laptop & Printer Repair Services
            Trusted IT Support & Networking Solutions
            CCTV Installation & Maintenance – Analog & IP Cameras
            Fast, Secure & Reliable Technical Assistance'
         />
         <section className='section-9 py-5'>
            <div className='container'>
               <div className='section-header text-center'>
                     <h2>Contact Us</h2>
                     <p>
                        Need reliable computer repair or IT services?
                        <br/>
                        Our skilled technicians are ready to assist you with repairs,
                        installations, and technical support. Fill out the form below
